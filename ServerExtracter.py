...
pdf = pdfplumber.open('CIS-server.pdf')

shutil.rmtree("./MD-files-server")
os.mkdir("./MD-files-server")
...
for i in range(1,21):
    os.mkdir("./MD-files-server/" + str(i)) # make folders for placing MD files

for pageNumber in range(55,1332): # in practice should be up to 1332
